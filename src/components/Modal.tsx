      ...
      {modalOpen ? (
        <div className="modal fixed top-0 left-0 z-10 flex h-full w-full items-center justify-center">
          <div
            ...
            onClick={close}
          ></div>
          <div className="modal-container relative min-h-[50%] min-w-[75%] cursor-default rounded bg-gray-200 p-[2.5rem] dark:bg-dark-gray md:min-w-[60%]">
            <div onClick={close} className="absolute right-3 top-3 cursor-pointer text-right text-2xl">
              ╳
            </div>
            {children}
          </div>
